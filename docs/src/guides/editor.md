...
highlighting, a symbol outline, and wires up the `dune lsp` server. It pins the
tree-sitter grammar to a commit of this repository, so highlighting always matches
